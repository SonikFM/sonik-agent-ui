/**
 * Vendored from open-design `question-form/src/runtime/partial-json.ts` (the
 * partial-json island). Kept as a local copy so the SvelteKit build does not
 * reach outside its project root; behavior must stay in sync with the donor.
 *
