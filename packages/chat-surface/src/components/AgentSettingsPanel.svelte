...
<div class="relative">
  <button
    type="button"
    class="inline-flex items-center gap-1.5 rounded-full px-3 py-1.5 text-sm text-muted-foreground transition-colors hover:bg-accent hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
    ...
    onclick={() => { open = true; }}
  >
    <!-- Settings icon path from lucide (ISC License, https://lucide.dev/icons/settings) -->
    <svg
      aria-hidden="true"
      width="16"
      height="16"
