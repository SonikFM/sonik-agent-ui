...
assert.doesNotMatch(failureStatusResolver, /\b(?:401|404|415|502|503)\b/, "unapproved thrown statuses are normalized to 500");
...
assert.match(generateRoute, /JSON\.stringify\(\{ error: resolveGenerateFailureMessage\(/, "the failure response uses the sanitized message resolver");
