...
assert.match(generateExecutionOrder, /const durableRunId = runRecorder\?\.runId \?\? smokeRunId/, "post-create lifecycle telemetry must select the durable run id once");
