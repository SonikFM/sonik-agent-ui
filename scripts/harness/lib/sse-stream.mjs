...
// via `ai`'s createUIMessageStreamResponse). Format, confirmed against
// node_modules/ai's JsonToSseTransformStream:
//   data: <json chunk>\n\n
//   ...
//   data: [DONE]\n\n
// Each chunk is a UIMessageChunk: {type: "text-start"|"text-delta"|"text-end"
// |"tool-input-start"|"tool-input-delta"|"tool-input-available"
// |"tool-output-available"|"error"|"start"|"finish"|..., ...}.
 ...
 * (paired input/output by toolCallId), message id, and any stream error.
 */
export function reduceUiMessageChunks(chunks) {
  ...
  return { messageId, text, toolCalls, error, finishReason, chunkCount: chunks.length };
}
